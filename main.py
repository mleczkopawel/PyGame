...
def game_loop():
    ...
    bonus_slower_car = GoodThing(random.randrange(0, positions.get_game_width()), -600, 100, 100, colors.get_green(),
                                 15, 0)
    bonus_less_width = GoodThing(random.randrange(0, positions.get_game_width()), -600, 100, 100, colors.get_blue(), 15,
                                 1)
    bonus_slower_bad_thing = GoodThing(random.randrange(0, positions.get_game_width()), -600, 100, 100,
    ...
    while not gameExit:
        ...
        bonus_slower_car.make_text('Slower car bonus: ', gameDisplay, (positions.get_game_width() - 250, 25))
        ...
        bonus_less_width.make_text('Less width: ', gameDisplay, (positions.get_game_width() - 250, 45))
